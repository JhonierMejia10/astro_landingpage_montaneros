                    ...
                    {lista_ofertas.map((oferta) => (
                        ...
                        >
                            ...
                            <div className="relative aspect-square bg-secondary overflow-hidden">
                                <img src={oferta.photo.src} alt={`Llanta ${oferta.brand} ${oferta.name} medida ${oferta.size}`} width={600} height={600} loading="lazy" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
