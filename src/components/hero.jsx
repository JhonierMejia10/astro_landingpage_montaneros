    ...
    return (
        <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden">
            ...
            <div className="absolute inset-0 bg-zinc-900">
                <img src={heroBackground.src} alt="Llantas de alta calidad en exhibición — Los Montañeros Medellín" width={1024} height={1024} fetchPriority="high" className="w-full h-full object-cover opacity-70" />
            </div>
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-6 py-32 md:py-40">
                <div className="max-w-2xl">
                    ...
                    <div className="mt-16 grid grid-cols-3 gap-6 border-t border-border pt-8">
                        <div>
                            <p className="text-2xl md:text-3xl font-bold text-primary" style={{ fontFamily: "var(--font-heading)" }}>+30</p>
